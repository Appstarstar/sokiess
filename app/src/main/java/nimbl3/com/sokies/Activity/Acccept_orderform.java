...
public class Acccept_orderform extends AppCompatActivity {
    private List<acceptorder_list> listItemsList = new ArrayList<>();
    acceptorder_adapter address_adapter;
    String query;
    InputStream is = null;
    String result = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acccept_orderform);
        ...
        queue = Volley.newRequestQueue(Acccept_orderform.this);
        Load_Advisor_advise();
    }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < sportarraydata2.length(); i++) {
                        ...
                        acceptorder_list advisor_customer_group_list = new acceptorder_list();
                        advisor_customer_group_list.setOrder_no1(sportarraydata.getString("order_no"));



                        listItemsList.add(advisor_customer_group_list);
                        address_adapter = new acceptorder_adapter(Acccept_orderform.this, listItemsList);
