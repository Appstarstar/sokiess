...
public class adminaccepted_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<adminaccepted_list> listItemsList;
    ...
    public adminaccepted_adapter(android.content.Context context, List<adminaccepted_list> listItemsList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup viewGroup, int position) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.assigned2_form, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        adminaccepted_list advisorname = listItemsList.get(position);
    ...
    public void intent_transfer(int position) {
        Intent intent = new Intent(Context, Adminaccepted.class);
