...
public class assignadmin_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<assignadmin_list> listItemsList;
    ...
    public assignadmin_adapter(android.content.Context context, List<assignadmin_list> listItemsList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup viewGroup, int position) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.assigned1_form, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        assignadmin_list advisorname = listItemsList.get(position);
    ...
    public void intent_transfer(int position) {
        Intent intent = new Intent(Context, accept_assignform_admin.class);
