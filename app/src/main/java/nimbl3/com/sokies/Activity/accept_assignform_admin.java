...
public class accept_assignform_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accept_assignform_admin);
        ...
        queue = Volley.newRequestQueue(accept_assignform_admin.this);
        ...
        card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(accept_assignform_admin.this, Assign_orderform_admin.class);
