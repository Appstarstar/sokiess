...
public class Assignedorder_projectmanager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assignedorder_projectmanager);
        ...
        queue = Volley.newRequestQueue(Assignedorder_projectmanager.this);
        Load_Advisor_advise();
    }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < sportarraydata2.length(); i++) {
                        ...
                        address_adapter = new assigned_adapter(Assignedorder_projectmanager.this, listItemsList);
