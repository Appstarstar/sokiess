...
public class Assign_orderform_admin extends AppCompatActivity {
    private List<assignadmin_list> listItemsList = new ArrayList<>();
    assignadmin_adapter address_adapter;
    String query;
    InputStream is = null;
    String result = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assign_orderform_admin);
        ...
        queue = Volley.newRequestQueue(Assign_orderform_admin.this);
        Load_Advisor_advise();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < sportarraydata2.length(); i++) {
                        ...
                        assignadmin_list advisor_customer_group_list = new assignadmin_list();
                        advisor_customer_group_list.setOrder_no1(sportarraydata.getString("order_no"));


                        listItemsList.add(advisor_customer_group_list);
                        address_adapter = new assignadmin_adapter(Assign_orderform_admin.this, listItemsList);
