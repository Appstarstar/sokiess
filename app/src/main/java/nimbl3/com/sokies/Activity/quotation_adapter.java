...
public class quotation_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<quotation_list> listItemsList;
    ...
    public quotation_adapter (android.content.Context context, List<quotation_list> listItemsList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        quotation_list advisorname = listItemsList.get(position);
        ...
        holder2.quotation_no.setText(advisorname.getInvoice());
        holder2.name_quotation.setText(advisorname.getName());
    ...
    public class ListRowViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        protected TextView name_quotation,quotation_no,date1,net,invoice,other,address,fax,kind,mobile,email,invoice_no,date,prepared_name,prepared_designation,packing,packing_rate,renmark,gst_invoice,gst_rate,prepared_mobile,total,order_no, HairStraightening, HairColouring, HairCut, HairCute;
        String c1, data;
...
*/
    ...
    public void intent_transfer(int position) {
        Intent intent = new Intent(Context, QuotationMaster.class);
        intent.putExtra("quotation_no", listItemsList.get(position).getInvoice());
