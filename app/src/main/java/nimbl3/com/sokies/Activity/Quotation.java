...
public class Quotation extends AppCompatActivity {
    ...
    private List<quotation_list> listItemsList = new ArrayList<>();
    private List<searchquot_list> listItemsList1 = new ArrayList<>();

    private RecyclerView mRecyclerView, mRecyclerView1;

    quotation_adapter address_adapter11;
...
searchquot_Adapter search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queue = Volley.newRequestQueue(Quotation.this);
        Load_Advisor_advise();
    ...
    public void Load_Advisor_advise() {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "http://gearboxindia.co.in/fetch_quotation.php", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < sportarraydata2.length(); i++) {
                        ...
                        quotation_list advisor_customer_group_list = new quotation_list();
                      ...
                      /*  advisor_customer_group_list.setAddress(sportarraydata.getString("address"));
                        ...
                        address_adapter11 = new quotation_adapter(Quotation.this, listItemsList);
                        mRecyclerView.setAdapter(address_adapter11);
      ...
      public void Load_Advisor_advise1() {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "http://gearboxindia.co.in/fetch_search_quot.php?name="+query, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.d("response", response.toString());
                ...
                try {
                    ...
                    if(search!=null){
                        ...
                        for (int i = 0; i < sportarraydata2.length(); i++) {
                            JSONObject sportarraydata = sportarraydata2.getJSONObject(i);
                            searchquot_list advisor_customer_group_list1 = new searchquot_list();
                      ...
                      /*advisor_customer_group_list.setAddress(sportarraydata.getString("address"));
                        ...
                        advisor_customer_group_list.setNet_amount(sportarraydata.getString("net_amount"));*/
                            ...
                            search = new searchquot_Adapter(Quotation.this, listItemsList1);
