...
public class purchase_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<purchase_list> listItemsList;
    ...
    public purchase_adapter (android.content.Context context, List<purchase_list> listItemsList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        purchase_list advisorname = listItemsList.get(position);
        ...
        holder2.purchase_no.setText(advisorname.getInvoice3());
        holder2.name_purchase.setText(advisorname.getName3());
...
*/
    ...
    public void intent_transfer(int position) {
        ...
        intent.putExtra("order_no", listItemsList.get(position).getInvoice3());
