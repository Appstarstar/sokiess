...
public class acceptorder_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<acceptorder_list> listItemsList;
    ...
    public acceptorder_adapter(android.content.Context context, List<acceptorder_list> listItemsList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        acceptorder_list advisorname = listItemsList.get(position);
    ...
    public void intent_transfer(int position) {
        Intent intent = new Intent(Context,Accept_order_form.class);
