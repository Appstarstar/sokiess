...
public class Admin_accepted_form extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queue = Volley.newRequestQueue(Admin_accepted_form.this);
        Load_Advisor_advise();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < sportarraydata2.length(); i++) {
                        ...
                        address_adapter = new adminaccepted_adapter(Admin_accepted_form.this, listItemsList);
