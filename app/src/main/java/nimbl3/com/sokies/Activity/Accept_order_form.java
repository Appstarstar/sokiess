...
public class Accept_order_form extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accept_order_form);
        ...
        queue = Volley.newRequestQueue(Accept_order_form.this);
        ...
        card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Accept_order_form.this, Acccept_orderform.class);
