...
public class Purchase extends AppCompatActivity {
    EditText email,fax_no,prepared_name,prepared_mobile,prepared_designation,price,gst1,inspection,payment,delivery,validity,get_address,kind_attention,mobile;
    Spinner Myspinner;
    TextView quotation_no,date1;
    RequestQueue queue;
    String quotation,order_no;
    Button ok_quot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobile=(EditText)findViewById(R.id.et_mobile_purchase);
        ...
        queue = Volley.newRequestQueue(Purchase.this);
        ...
        ok_quot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Purchase.this, Purchase_order.class);
    ...
    public void Load_Advisor_advise() {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "http://gearboxindia.co.in/fetch_purchaseorder_through_order_no.php?order_no="+order_no, null, new com.android.volley.Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < sportarraydata2.length(); i++) {
                        ...
                        quotation_no.setText(sportarraydata.getString("order_no"));
                        ...
                        mobile.setText(sportarraydata.getString("mobile"));
                        worldlist.add(sportarraydata.getString("name"));


                        // Spinner adapter
                        Myspinner
                                .setAdapter(new ArrayAdapter<String>(Purchase.this,
