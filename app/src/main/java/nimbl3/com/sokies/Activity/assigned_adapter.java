...
public class assigned_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<assigned_list> listItemsList;
    ...
    public assigned_adapter(android.content.Context context, List<assigned_list> listItemsList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        assigned_list advisorname = listItemsList.get(position);
