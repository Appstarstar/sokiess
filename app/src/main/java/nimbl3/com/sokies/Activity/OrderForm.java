...
public class OrderForm extends AppCompatActivity implements API_Result ,View.OnClickListener{
    private ArrayList listItemsList = new ArrayList<String>();
    ...
    EditText get_gears, get_drawing_no, get_ratio, get_quantity, get_partyname, get_remarkorder,get_delivery_date,get_typegears,get_efficiencey,get_balance, get_deliver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queue = Volley.newRequestQueue(OrderForm.this);
        Load_Advisor_advise();
        ...
        update = (Button) findViewById(R.id.btn_update_order);
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrderForm.this, Update_orderform.class);
    ...
    public void Load_Advisor_advise() {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "http://gearboxindia.co.in/projectmanager.php", null, new com.android.volley.Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.d("response", response.toString());

                try {
                    JSONArray sportarraydata2 = response.getJSONArray("result");
                    ...
                    for (int i = 0; i < sportarraydata2.length(); i++) {
                        ...
                        // Spinner adapter
                        My_spinner
                                .setAdapter(new ArrayAdapter<String>(OrderForm.this,
...
//                    adapter.notifyDataSetChanged();
    ...
    public void Load_Advisor_advise1() {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "http://gearboxindia.co.in/order.php", null, new com.android.volley.Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.d("response", response.toString());
...
//                    adapter.notifyDataSetChanged();
    ...
    public void register(View v){
        ...
        delivery_date= year1 + month1 + day1;
        new Background().execute(type_gear_box,size_gear_box, drawing_no,ratio,quantity,party_name,remarks,order_date,delivery_date);
    ...
    class Background extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://gearboxindia.co.in/orderform.php");
        ...
        protected void onPostExecute(String s) {
            ...
            Intent intent=new Intent(OrderForm.this,Login.class);
            startActivity(intent);
            finish();
