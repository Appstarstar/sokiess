package nimbl3.com.sokies.shared_preferences;
...
public class DataStorage {
    ...
    public static int mStoreSharedPreferenceInteger(Context context, String name, int value){
        SharedPreferences pref = context.getSharedPreferences(JSON_Names.KEY_SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        if( pref.contains(name)){
            DataStorage.mRemoveSharedPreferenceString(context,name);
    ...
    public static int mRetrieveSharedPreferenceInteger(Context context, String name, int i){
        SharedPreferences pref = context.getSharedPreferences(JSON_Names.KEY_SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE);
