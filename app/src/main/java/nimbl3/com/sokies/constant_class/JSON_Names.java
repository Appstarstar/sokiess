...
public class JSON_Names {
    ...
    public static String KEY_NO_DATA = "No Data";
    ...
    public static String KEY_SHARED_PREFERENCE_NAME = "Exlcart";
    public static String KEY_NAVIGATION_DATA = "Navigation_Data";
    public static String ALERT = "alert";
    public static String PROJECT = "project";
    public static String MVH_PROJECT = "mvh_project";
    public static String LEADS = "leads";
    public static String CONTACT = "contact";
    public static String CAMPAINING = "campaining";
    ...
    public static String KEY_FIRST_NAME = "f_name";
    ...
    public static String KEY_EMAIL = "e_mail_add";
    public static String KEY_TELEPHONE = "p_no";
    ...
    public static String KEY_IMAGE_IMAGE_FULL_VIEW="Image";

    //Product Details
    public static String KEY_REQUIRED_VALUE="1";
    public static String KEY_PD_PRODUCT="Product";
    public static String KEY_PD_IMAGE="Image";
    public static String KEY_PD_OPTION="Option";
    public static String KEY_PD_REVIEW="Review";
    ...
    //Product parent
    public static String KEY_FROM_SEARCH="TRUE";
    ...
    public static String KEY_DEFAULT_FIRST_NAME="name";
